...
$_url = new ZariliaFormText( _US_WEBSITE, 'url', 30, 30, '' );
$_url->setDescription( _US_WEBSITE_DSC );
$register_form->addElement( $_url, true );

$_timezone_offset = new ZariliaFormSelectTimezone( _US_TIMEZONE, 'timezone_offset', 0 );
$_timezone_offset->setDescription( _US_TIMEZONE_DSC );
$register_form->addElement( $_timezone_offset, false );

$register_form->addElement( new ZariliaFormRadioYN( _US_MAILOK, 'user_mailok', 1 ) );

$register_form->insertSplit( _US_USER_LOGIN_HEADING );

$ulogin = new ZariliaFormText( _US_ULOGINNAME, 'ulogin', 30, 30, '' );
$ulogin->setDescription( _US_ULOGINNAME_DSC );
$register_form->addElement( $ulogin, true );

$pass = new ZariliaFormPassword( _US_PASSWORD, 'pass', 10, 32, '', 1 ) ;
...
$captcha = new ZariliaFormCaptcha( _US_VERI, 'captacha', 5, 5, '' );
