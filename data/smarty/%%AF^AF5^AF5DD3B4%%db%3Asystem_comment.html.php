...
</div><img class="comUserRankImg" src="<?php echo $this->_tpl_vars['zarilia_upload_url']; ?>
/<?php echo $this->_tpl_vars['comment']['poster']['rank_image']; ?>
" alt="" /></div><img class="comUserImg" src="<?php echo $this->_tpl_vars['zarilia_upload_url']; ?>
...
:</span> <?php echo $this->_tpl_vars['comment']['poster']['postnum']; ?>
          ...
          <td class="odd">
            <div class="comTitle"><?php echo $this->_tpl_vars['comment']['image'];  echo $this->_tpl_vars['comment']['title']; ?>
        ...
        <tr>
          ...
          <?php if ($this->_tpl_vars['zarilia_iscommentadmin'] == true): ?>
...
" /></a>
          ...
          <?php elseif ($this->_tpl_vars['zarilia_isuser'] == true && $this->_tpl_vars['zarilia_userid'] == $this->_tpl_vars['comment']['poster']['id']): ?>
...
" /></a>
          ...
          <?php elseif ($this->_tpl_vars['zarilia_isuser'] == true || $this->_tpl_vars['anon_canpost'] == true): ?>
