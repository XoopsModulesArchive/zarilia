...
<?php if ($this->_tpl_vars['zarilia_notification']['show']): ?>
<form name="notification_select" op="<?php echo $this->_tpl_vars['zarilia_notification']['target_page']; ?>
" method="post">
<h4 style="text-align:center;"><?php echo $this->_tpl_vars['lang_activenotifications']; ?>
</h4>
<input type="hidden" name="not_redirect" value="<?php echo $this->_tpl_vars['zarilia_notification']['redirect_script']; ?>
" />
<table class="outer">
  ...
  <tr>
    ...
    <td class="head"><input name="allbox" id="allbox" onclick="zariliaCheckAll('notification_select','allbox');" type="checkbox" value="<?php echo $this->_tpl_vars['lang_checkall']; ?>
" /></td>
    <td class="head"><?php echo $this->_tpl_vars['lang_events']; ?>
</td>
  </tr>
  <?php $_from = $this->_tpl_vars['zarilia_notification']['categories']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['outer'] = array('total' => count($_from), 'iteration' => 0);
...
" />
  ...
  <?php endforeach; endif; unset($_from); ?>
  <tr>
    <td class="foot" colspan="3" align="center"><input type="submit" class="formbutton" name="not_submit" value="<?php echo $this->_tpl_vars['lang_updatenow']; ?>
" /></td>
  </tr>
</table>
<div align="center">
